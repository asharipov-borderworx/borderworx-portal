                      ...
                      <div className="text-center">
                        ...
                        {index === 1 && (
                          <div className="text-center">
                            ...
                            <p className="text-gray-600">Committed to sustainable logistics practices and environmental responsibility</p>
                          </div>
                        )}
                        {index === 2 && (
                          <div className="text-center">
                            ...
                            <p className="text-gray-600">International capabilities with specialized Canada-US corridor expertise</p>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          <div className="container-max">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href={`tel:${contactInfo.contact.address.Canada.phone}`}
